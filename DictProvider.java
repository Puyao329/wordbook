...
public class DictProvider extends ContentProvider{
    ...
    private static final int WORDS=1;//UriMathcher匹配结果
    private static final int WORD=2;
    private MyDatabaseHelper myDatabaseHelper;
    static{
        matcher.addURI(Words.AUTHORITY, "word", WORDS);//多条数据的路径
        matcher.addURI(Words.AUTHORITY, "word/#", WORD);//单条数据的路径
    }
    ...
    public int delete(Uri arg0, String arg1, String[] arg2) {
        ...
        switch(matcher.match(arg0)){
            ...
            case WORD:
                ...
                String whereClause=Words.Word._ID+"="+arg0.getPathSegments().get(1);
...
//                }
    ...
    public String getType(Uri arg0) {
        ...
        switch(matcher.match(arg0)){
            case WORDS://多条记录
                return "vnd.android.cursor.dir/com.example.wordbook";
            case WORD:
                return "vnd.android.cursor.item/com.example.wordbook";
            default:
                throw new IllegalArgumentException("未知Uri:"+arg0);
        }
    }
...
//                return database.query("dict", arg1, whereCaluse, arg3, null, null, arg4);
                queryBuilder.appendWhere(Words.Word._ID+"="+arg0.getPathSegments().get(1));
                return queryBuilder.query(database,arg1,arg2,arg3,null,null,arg4);
            default:
                throw new IllegalArgumentException("未知Uri:"+arg0);
        }
...
//                }
                ...
                num=database.update("dict", arg1,Words.Word._ID+"="+segment,arg3);
                break;
            default:
                throw new IllegalArgumentException("未知Uri:"+arg0);
        }
        //通知ContentResolver,数据已经改变
        getContext().getContentResolver().notifyChange(arg0, null);
        return num;
    }
